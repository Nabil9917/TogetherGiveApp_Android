package de.hsos.prog.app.data.repository;

import android.app.Application;
import androidx.lifecycle.LiveData;
import java.util.List;
import java.util.concurrent.CompletableFuture;
import de.hsos.prog.app.data.dao.GroupDao;
import de.hsos.prog.app.data.dao.PersonDao;
import de.hsos.prog.app.data.local.AppDatabase;
import de.hsos.prog.app.data.model.Group;
import de.hsos.prog.app.data.model.GroupWithPersons;
